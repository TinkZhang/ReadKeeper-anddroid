 ...
 * Use the [ReadingDetailFragment.newInstance] factory method to
...
class ReadingDetailFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        detail_title.text = viewModel.books.value?.get(0)?.title
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment ReadingDetailFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
                ReadingDetailFragment().apply {
